            ...
            <div class="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
                    ...
                    <div class="space-y-1 text-center">
                        <dl class="space-y-10">
                            <div>
                                ...
                                <dd class="text-base font-medium leading-6 text-gray-500 dark:text-gray-400"><time datetime="2023-08-05T00:00:00.000Z">${dayjs(data.date).format('dddd MMMM D, YYYY')}</time></dd>
                            </div>
                        </dl>
                        <div><h1 class="text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-5xl md:leading-14">${data.title}</h1></div>
                    </div>
                </header>
                ...
                <aside class="flex-1 p-6">
                    <div class="divide-y divide-gray-200 dark:divide-gray-700 xl:col-span-3 xl:col-start-4 xl:divide-y-0">
                        <div class="prose dark:prose-invert"><h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Tags</h2>
                        ${data.tags.map((tag) => `<a class="capitalize mr-3 text-sm font-medium decoration-none uppercase text-indigo-500 hover:text-primary-600 dark:hover:text-primary-400" href="/tags/${tag}">${tag}</a>`).join(' ')}</div>
                        </div>
                    </div> 
                </aside>
                </section>
